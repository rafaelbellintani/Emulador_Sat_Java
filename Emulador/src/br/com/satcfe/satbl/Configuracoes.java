...
public class Configuracoes
{
    public static String setSistemaOperacional() {
        ...
        ControleLogs.logar("Sistema Operacional: " + os + " | Versão: " + osVersion);
        try {
            if (os.indexOf("WIN") >= 0) {
    ...
    public static class SistemaArquivos
    {
        ...
        static {
            ...
            SistemaArquivos.CAMINHO_ARQUIVO_PARAMETRIZACAO_FABRICA_LINUX = String.valueOf(getDiretorioRaiz()) + "ParametrizacaoDeFabrica.xml";
            ...
            SistemaArquivos.CAMINHO_ARQUIVO_SAT_OFFLINE = String.valueOf(SistemaArquivos.DIRETORIO_ARQUIVO_DAT) + "SAT_OFFLINE.dat";
