...
import br.com.satcfe.satbl.modelos.soap.MensagemConsultaGestao;
...
public class WebServiceCFeConsultaGestao extends WebService
{
    private String urlWebService;
    private String nomeMetodo;
    private String cmd;
    private String vigenciaLeiaute;
    private String paramFabrica;
    private String tabelaANP;
    
    public WebServiceCFeConsultaGestao() {
        this.urlWebService = String.valueOf(Configuracoes.SAT.protocolo) + "://" + Parametrizacoes.endereco[0] + ":" + Parametrizacoes.porta + "/" + Parametrizacoes.CFeConsultaGestao;
        this.nomeMetodo = null;
        this.cmd = null;
        this.vigenciaLeiaute = null;
        this.paramFabrica = null;
        this.tabelaANP = null;
        this.nomeMetodo = "cfeConsultaGestao";
        this.nameSpace = "http://www.fazenda.sp.gov.br/sat/wsdl/CfeConsultaGestao";
    ...
    private String gerarSOAP() {
        final MensagemConsultaGestao msg = new MensagemConsultaGestao();
    ...
    private boolean tratarRetorno(String retorno) {
        try {
            ...
            if (!ControleAssinaturaXML.validarAssinaturaXml(ControleDados.recuperaTag(retorno, "retGestao"), "infGestao")) {
                ControleLogs.logar("Assinatura XML do retorno inv\u00e1lida.");
                return false;
            }
            this.vigenciaLeiaute = ControleDados.getConteudoTAG(retorno, "vigenciaLeiaute");
            this.paramFabrica = ControleDados.getConteudoTAG(retorno, "paramFabrica");
            this.tabelaANP = ControleDados.getConteudoTAG(retorno, "tabelaANP");
    ...
    public String getVigenciaLeiaute() {
        return this.vigenciaLeiaute;
    }
    
    public String getParamFabrica() {
        return this.paramFabrica;
    }
    
    public String getTabelaANP() {
        return this.tabelaANP;
    }
}
