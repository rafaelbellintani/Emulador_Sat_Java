...
import br.com.satcfe.satbl.modelos.soap.MensagemLogs;
...
public class WebServiceCFeLogs extends WebService
{
    private String log;
    ...
    public WebServiceCFeLogs() {
        this.log = null;
        this.nomeMetodo = null;
        this.urlWebService = String.valueOf(Configuracoes.SAT.protocolo) + "://" + Parametrizacoes.endereco[0] + ":" + Parametrizacoes.porta + "/" + Parametrizacoes.CFeLogs;
        this.cmd = null;
        this.nomeMetodo = "cfeLog";
        this.nameSpace = "http://www.fazenda.sp.gov.br/sat/wsdl/CfeLogs";
    ...
    private String gerarSOAP() {
        final MensagemLogs msg = new MensagemLogs();
        msg.setLog(this.log);
    ...
    private boolean tratarRetorno(String retorno) {
        try {
            ...
            if (!ControleAssinaturaXML.validarAssinaturaXml(ControleDados.recuperaTag(retorno, "retEnvLog"), "infLog")) {
