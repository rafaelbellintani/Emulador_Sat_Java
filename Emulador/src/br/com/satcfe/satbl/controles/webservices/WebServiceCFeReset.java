...
import br.com.satcfe.satbl.modelos.soap.MensagemReset;
...
public class WebServiceCFeReset extends WebService
{
    private String urlWebService;
    private String nomeMetodo;
    private String cmd;
    
    public WebServiceCFeReset() {
        this.urlWebService = String.valueOf(Configuracoes.SAT.protocolo) + "://" + Parametrizacoes.endereco[0] + ":" + Parametrizacoes.porta + "/" + Parametrizacoes.CFeReset;
        this.nomeMetodo = null;
        this.cmd = null;
        this.nomeMetodo = "cfeReset";
        this.nameSpace = "http://www.fazenda.sp.gov.br/sat/wsdl/CfeReset";
    ...
    private String gerarSOAP() {
        final MensagemReset msg = new MensagemReset();
    ...
    private boolean tratarRetorno(String retorno) {
        try {
            ...
            if (!ControleAssinaturaXML.validarAssinaturaXml(ControleDados.recuperaTag(retorno, "retConfReset"), "infReset")) {
