...
public class ParametrizacaoAtivacao
{
    private Node raiz;
    
    public ParametrizacaoAtivacao() {
        this.raiz = null;
    }
    
    public ParametrizacaoAtivacao(final String xml) {
        this.raiz = null;
    ...
    private boolean parse(final Node raiz) {
        try {
    ...
    public static boolean existe() {
        return ControleArquivos.existeArquivo(Configuracoes.SistemaArquivos.CAMINHO_ARQUIVO_PARAMETRIZACAO_ATIVACAO);
    }
}
