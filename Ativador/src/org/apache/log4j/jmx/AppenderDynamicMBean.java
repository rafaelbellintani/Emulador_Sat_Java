...
public class AppenderDynamicMBean extends AbstractDynamicMBean
{
    ...
    void registerLayoutMBean(final Layout layout) {
        ...
        final String name = this.appender.getName() + ",layout=" + layout.getClass().getName();
        ...
        try {
            ...
            if (!super.server.isRegistered(objectName)) {
                super.server.registerMBean(appenderMBean, objectName);
