...
abstract class RS485Port extends CommPort
{
    ...
    public abstract void setRS485PortParams(final int p0, final int p1, final int p2, final int p3) throws UnsupportedCommOperationException;
    ...
    public abstract void addEventListener(final RS485PortEventListener p0) throws TooManyListenersException;
