...
public abstract class SerialPort extends CommPort
{
    ...
    public abstract boolean setParityErrorChar(final byte p0) throws UnsupportedCommOperationException;
    
    public abstract byte getEndOfInputChar() throws UnsupportedCommOperationException;
    
    public abstract boolean setEndOfInputChar(final byte p0) throws UnsupportedCommOperationException;
    
    public abstract boolean setUARTType(final String p0, final boolean p1) throws UnsupportedCommOperationException;
    
    public abstract String getUARTType() throws UnsupportedCommOperationException;
    
    public abstract boolean setBaudBase(final int p0) throws UnsupportedCommOperationException, IOException;
    
    public abstract int getBaudBase() throws UnsupportedCommOperationException, IOException;
    
    public abstract boolean setDivisor(final int p0) throws UnsupportedCommOperationException, IOException;
    ...
    public abstract boolean setCallOutHangup(final boolean p0) throws UnsupportedCommOperationException;
