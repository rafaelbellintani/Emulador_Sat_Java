...
final class Raw extends RawPort
{
    ...
    private final RawOutputStream out;
    private final RawInputStream in;
    private int speed;
    ...
    public Raw(final String s) throws PortInUseException {
        this.out = new RawOutputStream();
        this.in = new RawInputStream();
        this.speed = 9600;
        this.dataBits = 8;
        this.stopBits = 1;
        this.parity = 0;
        ...
        this.open(this.ciAddress = Integer.parseInt(s));
    }
    
    private native int open(final int p0) throws PortInUseException;
    ...
    public void setRawPortParams(final int speed, final int dataBits, final int stopBits, final int parity) throws UnsupportedCommOperationException {
        this.nativeSetRawPortParams(speed, dataBits, stopBits, parity);
        this.speed = speed;
    ...
    private native void nativeSetRawPortParams(final int p0, final int p1, final int p2, final int p3) throws UnsupportedCommOperationException;
    ...
    public void sendEvent(final int i, final boolean b) {
        ...
        final RawPortEvent rawPortEvent = new RawPortEvent(this, i, !b, b);
        if (this.SPEventListener != null) {
            this.SPEventListener.RawEvent(rawPortEvent);
        }
    }
    
    public void addEventListener(final RawPortEventListener spEventListener) throws TooManyListenersException {
        if (this.SPEventListener != null) {
    ...
    public String getVersion() {
        return "$Id: Raw.java,v 1.1.2.13 2004/10/12 08:59:27 jarvi Exp $";
    }
    ...
    class RawOutputStream extends OutputStream
    {
        public void write(final int n) throws IOException {
            Raw.this.writeByte(n);
        }
        
        public void write(final byte[] array) throws IOException {
            Raw.this.writeArray(array, 0, array.length);
        }
        
        public void write(final byte[] array, final int n, final int n2) throws IOException {
            Raw.this.writeArray(array, n, n2);
        }
    ...
    class RawInputStream extends InputStream
    {
        ...
        public int read(final byte[] array, final int n, final int n2) throws IOException {
            ...
            int i;
            int[] array2;
            for (i = 0, array2 = new int[] { array.length, Raw.this.InputBuffer, n2 }; array2[i] == 0 && i < array2.length; ++i) {}
            int min = array2[i];
            ...
            int min2 = Math.min(min, Raw.this.threshold);
            if (min2 == 0) {
                min2 = 1;
            }
            this.available();
            return Raw.this.readArray(array, n, min2);
        }
